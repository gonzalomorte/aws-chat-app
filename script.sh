...
# ==================
# CONFIGURATION - First, create variable GITHUB_PAT in terminal (export GITHUB_PAT ...)
# ==================
ACCOUNT_ID=$(aws sts get-caller-identity --query Account --output text)
REGION="us-east-1"
ECR_BASE="${ACCOUNT_ID}.dkr.ecr.${REGION}.amazonaws.com"
REPO_URL="https://gonzalomorte:${GITHUB_PAT}@github.com/pwr-cloudprogramming/clprog2026-a04-mon1506.git"
